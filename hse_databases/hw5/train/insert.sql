...
VALUES ('Москва-Октябрьская', 10, 'Москва', 'Центральный'),
...
VALUES (101, 10, 'Ленинградский вокзал', 'Московский вокзал'),
...
VALUES ('Ленинградский вокзал', 'Тверь-Центральная', 102, '2024-03-10 08:00:00', '2024-03-10 10:30:00'),
       ('Москва-Октябрьская', 'Тверь-Центральная', 104, '2024-03-10 07:00:00', '2024-03-10 09:30:00');

-- Прямой рейс Москва-Санкт-Петербург
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Ленинградский вокзал', 'Московский вокзал', 101, '2024-03-10 12:00:00', '2024-03-10 18:30:00');

-- Рейсы с пересадкой Москва-Тверь-Санкт-Петербург
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Тверь-Центральная', 'Московский вокзал', 103, '2024-03-10 11:00:00', '2024-03-10 14:30:00');

-- Рейсы с пересадкой Москва-Тверь-Санкт-Петербург в разные дни
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Ленинградский вокзал', 'Тверь-Центральная', 102, '2024-03-10 20:00:00', '2024-03-10 22:30:00'),
...
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Ленинградский вокзал', 'Тверь-Центральная', 102, '2024-03-15 08:00:00', '2024-03-15 10:30:00'),
...
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Ленинградский вокзал', 'Тверь-Центральная', 102, '2024-03-16 22:00:00', '2024-03-16 23:59:59'),
...
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Казань-Пассажирская', 'Ленинградский вокзал', 108, '2024-03-18 10:00:00', '2024-03-18 18:00:00'),
...
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Владивосток-Главный', 'Сочи', 107, '2024-03-20 08:00:00', '2024-03-22 20:00:00');

-- Дополнительный маршрут Москва-Санкт-Петербург с пересадкой в Твери (подходит под условия запроса)
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Москва-Октябрьская', 'Тверь-Центральная', 104, '2024-03-25 07:00:00', '2024-03-25 09:30:00'),
...
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Ленинградский вокзал', 'Тверь-Центральная', 102, '2024-03-30 08:00:00', '2024-03-30 10:30:00'),
...
INSERT INTO Connection (FromStation, ToStation, TrainNr, Departure, Arrival)
VALUES ('Казань-Пассажирская', 'Ленинградский вокзал', 121, '2024-04-05 00:01:00', '2024-04-05 08:00:00'),
